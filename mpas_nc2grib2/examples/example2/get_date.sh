...
if [ ${#ff} -eq 4 ] ; then
	...
	dd2=$dd0
	hh2=$hh0
	export yy0=`date +%Y --date="$yy-$mm-$dd $hh $ff hour"`
	export mm0=`date +%m --date="$yy-$mm-$dd $hh $ff hour"`
	export mmm0=`date +%h --date="$yy-$mm-$dd $hh $ff hour"`
	export dd0=`date +%d --date="$yy-$mm-$dd $hh $ff hour"`
	export hh0=`date +%H --date="$yy-$mm-$dd $hh $ff hour"`
	echo "tempo de previsao....................:[$ff->$FFF]"
        echo "Data e hora sinotica.................:$yy0$mm0$dd0$hh0" 
